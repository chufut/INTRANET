...
AND correlativo.representacion = '$id_representacion' order by $orden $lista_query $limit");
   ...
   background-color: yellow;
	...
	$anio_actual = date("Y");
    $id_representacion = get_cookie_representacion();
    echo "Select sicar from representaciones where id = '$id_representacion'";
...
<form action="index.php" name="form_add_periodo" method="post">
		<table class="adminform">
            ...
            <tr <?php echo $display_sicar;?>>
				...
				<a href="/gua/archivos/sicar/<?php echo $archivo_sicar;?>" target="_blank">Consultar catálogo SICAR</a> <?php echo $anio; ?></td>
			</tr>
			<tr>
...
<fieldset class="adminform">
  ...
  <table class="adminform">
        ...
        <tr>
           ...
           <tr <?php if($id_representacion != 97) echo "style='display:none'"; ?>>
				<th class='title'>Expediente: </th>
				<td colspan="5">	
					<input type="text" name="expediente" value="<?php echo $correlativo_salida[0]['expediente'] ?>" id="periodo" size="40"/>		<a href="sicar2016.pdf" target="_blank">Consultar catálogo SICAR</a> <?php echo $anio; ?>		    </td>
		</tr> 
        <tr>
				<th class='title'>Archivo: </th>
